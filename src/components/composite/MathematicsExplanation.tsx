...
export function MathematicsExplanation({ plies, materials }: MathematicsExplanationProps) {
  ...
  const calculateABDStepByStep = () => {
    ...
    return { steps, A, B, D, totalThickness };
  };

  const { steps, A, B, D, totalThickness } = calculateABDStepByStep();
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="text-muted-foreground">Position: <span className="text-foreground font-semibold">z = {formatNumber(step.zStart)} to {formatNumber(step.zEnd)} mm</span></p>
                </div>
              </div>
              ...
              <div>
                ...
                {renderMatrix(step.Q_bar, 'Q̄ (MPa)')}
              </div>
